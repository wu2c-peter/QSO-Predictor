...
**New: Disambiguation dialog** — when WSJT-X UDP detects a possible Fox/Hound situation, QSOP now asks you to confirm which mode you're in rather than guessing. This prevents false activations.
...
> **Note:** Layer 2 inference was subsequently removed in v2.3.2 — on standard frequencies it was a false positive risk, on non-standard frequencies it was redundant. See [v2.3.2 Release Notes](RELEASE_NOTES_v2.3.2.md).
...
- **JTDX does not populate UDP special_mode field** — always returns 0. Manual combo box is the reliable F/H detection path for JTDX users.
