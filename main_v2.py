...
class MainWindow(QMainWindow):
    ...
    def __init__(self):
        ...
        # Instantiated after the other controllers because set_target cascades
        # through fox_hound and ionis on every target change.
        self.target = TargetCoordinator(self)
    ...
    def init_ui(self):
        ...
        self.btn_clear_target.clicked.connect(self.target.clear)
        ...
        clear_target_action.triggered.connect(self.target.clear)
    ...
    def sync_to_jtdx(self):
        ...
        self.target.set_target(self.jtdx_last_dx_call)
    ...
    def process_buffer(self):
        ...
        for item in chunk:
            ...
            if self.current_target_call:
                ...
                if state:
                    self.target.update_activity(state, other)
    ...
    def refresh_target_perspective(self):
        ...
        if self.current_target_call:
            ...
            self.target.check_activity_idle()
            ...
            if not self.current_target_grid or len(self.current_target_grid) < 2:
                grid, source = self.target.lookup_grid(self.current_target_call)
